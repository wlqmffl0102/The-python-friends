...
--------------------------""")
    ...
    # 4. 원하는 것이 예매 취소일 경우
        ...
        if check in user_list:
            # 입력 받은 사용자 id가 리스트에 있을 경우
            if check in movie_info:
                # 사용자로부터 입력 받은 id가 예매를 한 경우
                print("%s님은 %s를 예매하셨습니다." % (check,movie_info[check]))
                ...
                # 사용자로부터 입력 받은 id가 예매를 하지 않은 경우
                # (아이디는 O, 영화 예매는 X)
                print("%s님은 예매를 하지 않으셨습니다." % check)
    ...
    # 5. 원하는 것이 회원 탈퇴일 경우
        ...
        # 입력 받은 사용자 id가 리스트에 있을 경우
            ...
            # 사용자로 부터 yes(탈퇴) 입력 받았을 경우
                ...
                # 회원 탈퇴 이므로 사용자 id 리스트에서 해당 사용자  삭제
