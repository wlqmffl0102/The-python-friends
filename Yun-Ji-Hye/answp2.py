...
while  __________          # 문제1
    if yun[i] <= 60:
        _________________   # 문제2
    sum = sum+______        # 문제3
    i = i+1

avg = sum/len(yun)          # 평균=총합계/리스트의 길이
if avg >= 70 :
    first_condition=_____   # 문제 4-1

if len(fails) ==0:
    Second_condition=_____   # 문제 4-2
